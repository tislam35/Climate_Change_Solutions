...
ax.set_xlabel('Year')
ax.set_ylabel('US New Car Sales')
plt.legend()
...
mse = ((mte_forecast - mte_truth['Sales in thousands']) ** 2).mean()
print('The Mean Squared Error (MSE) of the forecast is {}'.format(round(mse, 2)))
print('The Root Mean Square Error (RMSE) of the forcast: {:.4f}'
      .format(np.sqrt(sum((mte_forecast-mte_truth['Sales in thousands'])**2)/len(mte_forecast))))
...
# Compute the mean square error
mse = ((mte_forecast - mte_orginal['Sales in thousands']) ** 2).mean()
print('The Mean Squared Error (MSE) of the forecast is {}'.format(round(mse, 2)))
print('The Root Mean Square Error (RMSE) of the forcast: {:.4f}'
