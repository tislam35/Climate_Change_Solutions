...
# Emission data taken from https://www.bp.com/en/global/corporate/energy-economics/statistical-review-of-world-energy.html
...
mse = ((mte_forecast - mte_truth['Global Emissions']) ** 2).mean()
print('The Mean Squared Error (MSE) of the forecast is {}'.format(round(mse, 2)))
print('The Root Mean Square Error (RMSE) of the forcast: {:.4f}'
      .format(np.sqrt(sum((mte_forecast-mte_truth['Global Emissions'])**2)/len(mte_forecast))))
...
# Compute the mean square error
mse = ((mte_forecast - mte_orginal['Global Emissions']) ** 2).mean()
print('The Mean Squared Error (MSE) of the forecast is {}'.format(round(mse, 2)))
print('The Root Mean Square Error (RMSE) of the forcast: {:.4f}'
      .format(np.sqrt(sum((mte_forecast-mte_orginal['Global Emissions'])**2)/len(mte_forecast))))
